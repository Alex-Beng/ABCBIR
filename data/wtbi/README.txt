...
Note
====
Be careful to not confuse product ids with photo ids. Every street2shop pair consists of a street photo ID, an annotated box and its corresponding clothing product ID.
Every product ID is mapped to one or more shop images, which you can find in retrievals_{category}.json files.
